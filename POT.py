...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    pot_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.ButtonOpen.configure(command=pot_support.btnOpenClick)
        ...
        self.ButtonStart.configure(command=pot_support.btnStartClick)
        ...
        self.ButtonExit.configure(command=pot_support.btnExitClick)
